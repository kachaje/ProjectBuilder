...
function createOtherForm(page){
    ...
    cell1_1.innerHTML = "<b>Number of questions in section</b>";
    ...
    input.name = "question_count_" + page
    input.onchange = function(){
        addQuestions(this.getAttribute("page"), this.value);
    }
    ...
    "<tbody id='tbody" + page + "'></tbody></table>";
