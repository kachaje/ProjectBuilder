...
function createPatientDashboardForm(page){
    var container;
    ...
    cell5_1.innerHTML = "<b>Number of links on dashboard</b>";
    ...
    input2.name = "link_count_" + page
    input2.onchange = function(){
        addDashboardLinks(this.getAttribute("page"), this.value, "DashLinks");
    }
    
    cell5_2.appendChild(input2);
    ...
    cell4_1.innerHTML = "<table style='float: right; width: 100%;' border='0' cellspacing='0' cellpadding='10'>" + 
    "<tbody id='tbodyDashLinks" + page + "'></tbody></table>";
